  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-2xl md:text-3xl text-gray-500 mb-8">AI Engineer</p>
        ...
        <p className="text-gray-600 text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
          A passionate developer dedicated to creating elegant solutions and continuous learning. Welcome to my
          portfolio where I showcase my projects and educational journey.
        </p>
